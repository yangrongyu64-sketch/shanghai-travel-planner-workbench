...
- [ ] `workbench-demo.zip`、`acceptance-report.zip`、`miniprogram-handoff.zip`、`official-refresh.zip`、`official-fillback.zip`、`maintenance-report.zip`、`release-evidence.zip` 都能解压。
- [ ] `service-worker.js` 包含 `official-refresh.zip`、`official-fillback.zip`、`maintenance-report.zip`、`release-evidence.zip` 和核心 HTML/PWA 文件。
