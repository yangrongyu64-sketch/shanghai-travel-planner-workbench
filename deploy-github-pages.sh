...
echo "Smoke check: open ${PAGES_URL} and confirm workbench-demo.zip, product-delivery.zip, acceptance-report.zip, official-refresh.zip, official-fillback.zip, and release-evidence.zip are downloadable."
# workbench-demo.zip, product-delivery.zip, acceptance-report.zip, official-refresh.zip, official-fillback.zip, and release-evidence.zip are included in this static site package.
