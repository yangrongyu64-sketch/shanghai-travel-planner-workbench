...
- `data-vault-recovery-evidence.md` / `data-vault-recovery-evidence.json`：数据保险箱恢复能力的发布留档和恢复演练口径。
...
5. 在“旅行数据保险箱”导出 `shanghai-traveler-data-vault.json`，完成一次恢复演练后留档。
6. 将本包、审计 Markdown、线上巡检 JSON/Markdown 和 Playwright 验收截图一起留档。
